...
func main() {
	...
	router.HandleFunc("/post/{id}/edit/{editid}", logging(editPost)).Methods("POST")
	router.HandleFunc("/post/{id}/edit/{editid}/post", logging(edit)).Methods("POST")
	router.HandleFunc("/post/{id}/delete/{editid}/", logging(deletePostWeb)).Methods()
