...
func main() {
	...
	router.HandleFunc("/api/v1/post/{id}/delete", logging(api.DeletePostAPI)).Methods("POST")
	...
	router.HandleFunc("/post/{id}/delete/post", logging(html.DeletePostForm)).Methods("POST")
